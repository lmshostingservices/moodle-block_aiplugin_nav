...
/**
 * AI Dashboard Quick Links v2.4.78 - Version information
 *
 * v2.4.81: LIVE-PIPELINE-RECUT (30 Aug 2026) — Re-cut the exact reviewed
 *          Quicklinks private-suite removal through the production pipeline
 *          after concurrent automation reserved v2.4.79 and v2.4.80.
 *          No source behavior or DB schema changes. Savepoint 2026083014.
 *
 * v2.4.79: IMMUTABLE-LIVE-RECUT (30 Aug 2026) — Re-cut the exact reviewed
 *          Quicklinks private-suite removal after the v2.4.78 tag was created
 *          by the development release environment. No source behavior or DB
 *          schema changes. Savepoint 2026083012.
 *
...
$plugin->version = 2026083014;  // YYYYMMDDXX (10-digit, matches release pipeline) — 30 Aug 2026. v2.4.81.
$plugin->release = 'v2.4.81';
$plugin->release_prev = '2.4.80';

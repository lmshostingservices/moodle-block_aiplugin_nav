...
/**
 * AI Dashboard Quick Links v2.4.48 - Version information
 *
...
$plugin->version = 2026080800215;  // YYYYMMDDNNNNN — 8 Aug 2026, sequence 215.
$plugin->release = 'v2.4.48';
$plugin->release_prev = '2.4.47';  // Previous release (compareVersions parse error — fixed here).
